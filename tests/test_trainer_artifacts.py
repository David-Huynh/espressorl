...
class TrainerArtifactTests(unittest.TestCase):
    def test_builds_expected_contract_artifacts_from_valid_dataset(self) -> None:
        ...
        self.assertEqual(tensor_contract["context_window_size"], 8)
        ...
        self.assertEqual(tensor_contract["tensor_shapes"]["context_static"], [1, 8, 20])
        self.assertEqual(tensor_contract["tensor_shapes"]["context_terminal"], [1, 8, 18])
        self.assertEqual(tensor_contract["tensor_shapes"]["context_mask"], [1, 8])
